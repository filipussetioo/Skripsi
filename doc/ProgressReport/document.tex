...
Detail bagian pekerjaan skripsi sesuai dengan rencan kerja/laporan perkembangan terkahir :
	\begin{enumerate}
		\item \textbf{Melakkan studi literatur mengenai \textit{Online Judge}.}\\
		...
		\item \textbf{Melakukan studi literatur mengenai \textit{SharIF Judge}.}\\
		{\bf Status :} Ada sejak rencana kerja skripsi.\\
		{\bf Hasil :}

		\item \textbf{Melakukan studi literatur mengenai \textit{CodeIgniter 3}}\\
		{\bf Status :} Ada sejak rencana kerja skripsi.\\
		{\bf Hasil :} \textit{CodeIgnier} merupakan sebuah \textit{framework} berbasis \textit{PHP}  

		\item \textbf{Melakukan studi literatur mengenai \textit{CodeIgniter 4}}\\
		{\bf Status :} Ada sejak rencana kerja skripsi.\\
		{\bf Hasil :}
...
\begin{enumerate}
\item Mempelajari cara kerja SharIF Jugde.
...
\begin{itemize}
	\item Beberapa \textit{library} yang tidak terdukung pada \textit{CodeIgntier 4}.
