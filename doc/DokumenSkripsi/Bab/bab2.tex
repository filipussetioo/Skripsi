...
\textit{Events} merupakan pembaharuan dari \textit{Hooks}. Pengguna harus mengubah \verb|$hook['post_controller_constructor']| menjadi  \texttt{Events::on('post_controller_constructor', ['MyClass', 'MyFunction']);} dengan \textit{namespace} \verb|CodeIgniter\Events\Events;|. 
