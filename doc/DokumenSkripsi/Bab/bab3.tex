...
\end{lstlisting}
Kode \ref{kode:uploadconvbab32} merupakan contoh sintaks untuk melakukan pengecekan \textit{extension} dan pengambilan data berupa nama dari file. Beberapa aturan tidak terdapat pada \textit{validation} sehingga akan dilakukan pengecekan manual.
